...
class DiscretizedIntersectionEnv(IntersectionEnv):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
...
class ContinuousIntersectionReward2(IntersectionEnv):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
...
class DiscreteIntersectionReward2(IntersectionEnv):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
...
register(
    id='intersection-v2',
    entry_point='highway_env.envs:DiscretizedIntersectionEnv',
)
...
register(
    id='intersection-v3',
    entry_point='highway_env.envs:ContinuousIntersectionReward2',
)

register(
    id='intersection-v4',
    entry_point='highway_env.envs:DiscreteIntersectionReward2',
)
